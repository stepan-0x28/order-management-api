...
def get_user_repository(db_session: Annotated[DBSessionWrapper, Depends(get_db_session)]) -> UserRepository:
...
def get_user_service(user_repository: Annotated[UserRepository, Depends(get_user_repository)],
                     ...
                     db_session: Annotated[DBSessionWrapper, Depends(get_db_session)]) -> UserService:

...
def get_order_repository(db_session: Annotated[DBSessionWrapper, Depends(get_db_session)]) -> OrderRepository:
...
def get_order_service(order_repository: Annotated[OrderRepository, Depends(get_order_repository)],
                      ...
                      db_session: Annotated[DBSessionWrapper, Depends(get_db_session)]) -> OrderService:
